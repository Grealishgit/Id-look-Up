...
const IdFinder = () => {
    ...
    return (
        <div className="max-w-screen-full mt-10 mx-auto py-12 px-4 bg-teal-100 min-h-screen" id="IdFinder">
            <h1 className="text-4xl font-bold text-center text-gray-800 mb-6">
                Find <span className="text-green-500">Your <span className='text-red-500'>ID</span> </span>
            </h1>
            <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto mb-8">
                Please enter your details below to locate your lost ID.
            </p>
